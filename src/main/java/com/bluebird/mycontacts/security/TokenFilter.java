...
public class TokenFilter extends OncePerRequestFilter {
    ...
    return new AntPathMatcher().match("/api/auth/**", request.getServletPath()) || new AntPathMatcher().match("/api/info/picture/**", request.getServletPath()) ||new AntPathMatcher().match("/api/info/hello/** re", request.getServletPath());
    }
}
